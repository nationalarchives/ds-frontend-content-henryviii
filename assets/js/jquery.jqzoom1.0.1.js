...
(function($)
{
    $.fn.jqzoom = function(options)
    {
        var settings = {
            ...
            zoomWidth: 460,		//zoomed width default width
            zoomHeight: 260,		//zoomed div default width
...
$(function(){
	var options1 =
	{
		...
		fadeoutSpeed: 'slow',
			alwaysOn: false,
            xOffset: 18,		//zoomed div default offset
            yOffset: 0,
		title: false
	}
...
/*$(function(){
	var options6 =
	{
		...
		alwaysOn: true,
		 zoomType: 'standard', //standard/reverse/innerzoom
		zoomWidth: 439,		//zoomed width default width
		zoomHeight: 258,		//zoomed div default width
		xOffset: -900,		//zoomed div default offset
		yOffset: -900,
		position: "left" ,//zoomed div default position,offset position is to the right of the image
		lens:true, //zooming lens over the image,by default is 1;
		lensReset : false,
